...
class MessageViewTestCase(TestCase):
    ...
    def test_unauthorized_message_delete(self):
        ...
        u = User.signup(username='unauthorized-user', email='test3@test.com', password='password3', image_url=None)
        u.id = 76543

        m = Message(id=1234, text='testing321', user_id=self.testuser_id)
