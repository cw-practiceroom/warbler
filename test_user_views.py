...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u4 = User.signup('testing', 'test4@gmail.com', 'password', None)
    ...
    def setup_likes(self):
        ...
        m3 = Message(id=9876, text='likeable warble', user_id=self.testuser_id)
    ...
    def test_remove_like(self):
        ...
        m = Message.query.filter(Message.text=='likeable warble').one()
    ...
    def test_unauthorized_following_page_access(self):
        ...
        with self.client as c:
            ...
            resp = c.get(f'/users/{self.testuser_id}/following', following_redirects=True)
            self.assertEqual(resp.status_code, 200)
            self.assertNotIn('@abc', str(resp.data))
            self.assertIn('Access unauthorized', str(resp.data))
